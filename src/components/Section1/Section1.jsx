  ...
  return (
    <section className="section1" id="section1">
      <div className="text">
        ...
        <p>
          Hi, my name is Pedro, I'm a 20 years old Full Stack Developer with a focus on
          JavaScript/TypeScript. Having more than 20 projects and 5 years of practice, I have
          experience with Front-End, Back-End and also Mobile development.
        </p>
